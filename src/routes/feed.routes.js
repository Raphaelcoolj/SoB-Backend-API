...
router.get('/top/:fieldId', [param('fieldId').isMongoId().withMessage('Invalid Field ID format'), validate], feedController.getTopPostsByField); // IMPROVED: Top 50 posts per field
